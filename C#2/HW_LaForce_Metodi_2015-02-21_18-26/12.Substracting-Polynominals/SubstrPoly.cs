...
Extend the previous program to support also subtraction and multiplication 
of polynomials.		
============================================================================
Solution:");
        Console.WriteLine();
        try
        {
            ...
            Console.Write("This is the normal form of the first polynomial:");
            PrintPolynomial(firstPolynomial);

            Console.WriteLine();

            decimal[] secondPolynomial = EnterPolynomial(out secondPolynomial);
            Console.Write("This is the normal form of the second polynomial:");
