...
define as sets of several neighbour elements located on the same line, 
...
");
        ...
        string[,] matrix = { 
           ...
           //input
        //Console.Write("Enter the size N of the matrix please");
        //int n = int.Parse(Console.ReadLine());
        //Console.Write("Enter the size M of the matrix please");
