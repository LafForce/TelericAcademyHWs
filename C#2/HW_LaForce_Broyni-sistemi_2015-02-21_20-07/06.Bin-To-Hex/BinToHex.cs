...
Solution:");
        ...
        Console.WriteLine("Enter binary number, please:");
        ...
        for (int i = 0; i < binyryStr.Length; i += 4)
        {
            ...
            switch (hexString)
            {
                ...
                case "0101": result += "5"; 
                    break;
                case "0110": result = "6" + result; 
                    break;
                case "0111": result = "7" + result; 
                    break;
                case "1000": result = "8" + result;
                    break;
                case "1001": result = "9" + result; 
                    break;
                case "1010": result = "A" + result; 
                    break;
                case "1011": result = "B" + result; 
                    break;
                case "1100": result = "C" + result; 
                    break;
                case "1101": result = "D" + result; 
                    break;
                case "1110": result = "E" + result; 
                    break;
                case "1111": result = "F" + result; 
                    break;
                default:
                    break;
            }
